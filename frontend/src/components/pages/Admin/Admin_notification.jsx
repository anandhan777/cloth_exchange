...
export default function Admin_NotificationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf9f5]  p-8 pt-20">
      ...
      <div className="mt-8 space-y-5">
        ...
        {activeTab.map((item, index) => (
          ...
          >
            ...
            <button className="bg-blue-50 hover:bg-blue-100 text-blue-600 px-5 py-2 rounded-xl flex items-center gap-2">
